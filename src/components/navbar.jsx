...
const Navbar = () => {
  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      {/* LINKS */}
      <div className="hidden md:flex text-black font-bold gap-4 w-1/3">
        {links.map((link) => (
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="text-yellow-500 font-extrabold mr-1">TIMBER</span>
          <span className="w-16 h-8 rounded bg-white text-red-700 font-extrabold flex items-center justify-center">
            SANY
          </span>
        </Link>
      </div>
      ...
      <div className="hidden md:flex gap-4 w-1/3">
        ...
        <Link href="/">
          <img src="/youtube.png" alt="" className="h-[24px]" />
        </Link>
        <Link href="/">
