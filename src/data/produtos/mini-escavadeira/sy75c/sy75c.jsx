const SY75C = {
  ...
  features: {
    ...
    high2: {
      descrição: "Potência Nominal: 58 HP / 2200 RPM",
      image: "/svgs/engine.svg",
    },
    high3: {
      descrição: "Capacidade da Caçamba: 0,32 M³",
  ...
  dev: {
    ...
    High: {
      High1: {
        image: "/svgs/engine.svg",
        title: "Alta Potência",
        desc: "Equipada com um motor ISUZU CP-4LE2XA-S de quatro cilindros, a SY75C oferece uma potência robusta para lidar com uma ampla gama de tarefas, desde escavação até movimentação de materiais pesados.",
      },
      High2: {
  ...
  specs: {
    Dimension: {
      ...
      data: {
        "Comprimento para transporte": "6.120 mm",
        "Largura para transporte": "2.220 mm",
        "Altura para transporte": "2.760 mm",
        "Largura superior": "2.040 mm",
        "Raio de giro traseiro": "1.800 mm",
        "Distância mínima do solo": "3.80 mm",
      },
    },
    Motor: {
      titulo: "Motor",
      image: "/svgs/engine.svg",
      data: {
        "Modelo de motor": "ISUZU CP-4LE2XA-S",
        "Potência nominal": "58 HP / 2200 RPM",
        "Torque máximo": "215/1800 N · m / rpm",
      },
    },
    Performance: {
      titulo: "Desempenho",
      ...
      data: {
        "Velocidade de deslocamento (max/min)": "2,4 km/h - 4,4 km/h",
